...
//Clase SPManager
function SPManager (_game, _boardGroup, _bulletGroup, _plantsGroup, _zombiesGroup, _currentWave, _HUDGroup, _sunGroup, _timeToSpawnSun){  
    this.game = _game;
    ...
    this.waveManager = new WaveManager(_game,_zombiesGroup, _currentWave);
